...
class ditailViewControllerNew: UIViewController, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        var pdf = "N.A."
        if(mickey["bill_id"]as? String == "s2-114"){
            pdf = "PDF Link"
            pdfURL = "https://www.gpo.gov/fdsys/pkg/BILLS-114s2is/pdf/BILLS-114s2is.pdf"
        }
        if(mickey["bill_id"]as? String == "hr6376-114"){
            pdf = "PDF Link"
            pdfURL = "https://www.gpo.gov/fdsys/pkg/BILLS-114hr6376ih/pdf/BILLS-114hr6376ih.pdf"
        }
        ...
        array = [detail(cell : 1, left : "Bill ID", right : (mickey["bill_id"]as? String)!),
                 ...
                 detail(cell : 1, left : "Status", right : "New")
        ]
